...
# Type: Bool
config.set('content.local_content_can_access_remote_urls', True, 'file:///Users/mags/Library/Application%20Support/qutebrowser/userscripts/*')

# Allow locally loaded documents to access other local URLs.
# Type: Bool
config.set('content.local_content_can_access_file_urls', False, 'file:///Users/mags/Library/Application%20Support/qutebrowser/userscripts/*')
...
config.set('url.searchengines', {'DEFAULT': 'https://google.com/search?hl=en&q={}'})

# External player (MPV)
config.bind(",a", "hint links spawn --detach mpv {hint-url}")
config.set('window.title_format', 'Mags - {current_title}{perc}')
# Navigation
config.bind("<Ctrl-d>", "scroll-page 0 0.5")
config.bind("<Ctrl-u>", "scroll-page 0 -0.5")
config.bind('<right>', 'tab-next', mode='normal')
config.bind('<left>', 'tab-prev', mode='normal')
config.bind('<Meta-o>', 'open -t https://google.com')
